...
public class Menu1 {
	...
	static Scanner integer1 = new Scanner(System.in);
      ...
      static void buildMenu(Connection conn) throws SQLException, ClassNotFoundException{
      ...
      static void deleteMenu(Connection conn) throws SQLException, ClassNotFoundException {
	...
	static void updateMenu(Connection conn) throws SQLException {
	...
	static void selectMenu(Connection conn) throws SQLException {
